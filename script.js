...
for  (let count = 1; count <= 10; count +=1 ){console.log (count)} 
...
for (let count = 1; count <= 100; count +=2 ){console.log (count)}

//4- Criar um loop que conte todos os números pares de 0 a 100
for (let count = 0; count <= 100; count +=2 ){console.log (count)}
